...
**(C) 의존성 lockfile within-pin 드리프트 — M-1 v27 [DONE — Phase 30-1] (`npm outdated` 실측)**

| 패키지 | 핀 | Current | Wanted | Latest | 분류 | 판정 |
|--------|-----|---------|--------|--------|------|------|
| `zod` | `^4.3.6`(deps) | 4.3.6 | **4.4.3** | 4.4.3 | prod-dep, 핀-내 minor | **M-1 v27 — [DONE — Phase 30-1]** |
| `@types/node` | `^20.12.7`(devDeps) | 20.19.33 | **20.19.43** | 25.9.3 | dev-dep, 핀-내 patch | **M-1 v27 — [DONE — Phase 30-1]** |
| `vitest` | `^4.1.2`(devDeps) | 4.1.2 | **4.1.9** | 4.1.9 | dev-dep, 핀-내 patch | **M-1 v27 — [DONE — Phase 30-1]** |
