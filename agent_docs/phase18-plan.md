...
## 2. Phase 18-1: 6개 도구 디스패처 단위 테스트 추가 (M-1 v15) — 테스트-only·무위험 [DONE]
...
| 18-1 **[DONE]** | M-1 v15: 6개 도구 디스패처 단위 테스트 추가(export_graph 우선) + diagnostic-v15 [DONE] — 15건 추가, vitest 563→578 그린 | 1 | 매우 낮음 (테스트-only, 프로덕션 코드 무변경) |
