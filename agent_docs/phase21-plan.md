...
## 2. Phase 21-1: postcss dev override — package.json 패치-floor (M-1 v18) — dev 위생·무위험
...
## 3. Phase 21-2: README 동기화 — docs only (L-9 docs) — 무위험
...
| 21-1 | M-1 v18: `overrides "postcss": "^8.5.10"` 추가 → dev 트리 audit moderate 0 + diagnostic-v18 [DONE] — 593 그린(불변), tsc 그린, prod audit 0(불변) | 1 | 매우 낮음 (dev 빌드 도구 트리 floor만, prod 무변경) |
| 21-2 | L-9 docs: README 3곳 동기화(Node ≥22, export_graph graphml/dot, REST API 8 라우트) + diagnostic-v18 [DONE] | 1 | 없음 (docs-only) |
